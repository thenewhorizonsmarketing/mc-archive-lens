...
import { AlumniSearch } from "@/components/room-search/AlumniSearch";
...
export default function AlumniRoom({ onNavigateHome, searchQuery }: AlumniRoomProps) {
  ...
  }, [alumniData, filterMode, selectedDecade, selectedYear, localSearchQuery, showOnlyWithPhotos, showOnlyLeadership, selectedRole]);
